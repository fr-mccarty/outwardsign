...
const listLocations: UnifiedToolDefinition = {
  name: 'list_locations',
  description:
...
const getLocation: UnifiedToolDefinition = {
  name: 'get_location',
...
const createLocation: UnifiedToolDefinition = {
...
const updateLocation: UnifiedToolDefinition = {
...
const deleteLocation: UnifiedToolDefinition = {
...
export const locationsTools: UnifiedToolDefinition[] = [
  listLocations,
  getLocation,
  createLocation,
  updateLocation,
