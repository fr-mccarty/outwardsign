...
const listPeople: UnifiedToolDefinition = {
  name: 'list_people',
  description:
...
const getPerson: UnifiedToolDefinition = {
  name: 'get_person',
...
const searchPeopleByName: UnifiedToolDefinition = {
...
const getMyInfo: UnifiedToolDefinition = {
  name: 'get_my_info',
...
const updateMyInfo: UnifiedToolDefinition = {
  name: 'update_my_info',
  ...
  async execute(args, context) {
    ...
    // Set audit context
    await setMCPAuditContext(context.userId || context.personId, context.userEmail || undefined)
...
// ============================================================================
// WRITE TOOLS (Staff/MCP)
// ============================================================================

const createPerson: UnifiedToolDefinition = {
  name: 'create_person',
...
const updatePerson: UnifiedToolDefinition = {
  name: 'update_person',
  description:
...
const deletePerson: UnifiedToolDefinition = {
  name: 'delete_person',
  description:
...
export const peopleTools: UnifiedToolDefinition[] = [
  // Read tools (staff/mcp)
  listPeople,
  getPerson,
  searchPeopleByName,
