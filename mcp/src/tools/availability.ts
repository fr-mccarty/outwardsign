...
const getPersonAvailability: UnifiedToolDefinition = {
...
const checkAvailability: UnifiedToolDefinition = {
  ...
  async execute(args, context) {
    ...
    // Find any blackout that overlaps this date
...
// Parishioner: Get my blackouts
const getMyBlackouts: UnifiedToolDefinition = {
...
const addBlackoutDate: UnifiedToolDefinition = {
...
const removeBlackoutDate: UnifiedToolDefinition = {
  ...
  async execute(args, context) {
    ...
    const personName = (blackout.person as { full_name: string })?.full_name || 'Person'
...
// Parishioner: Add my blackout
const addMyBlackout: UnifiedToolDefinition = {
...
// Parishioner: Remove my blackout
const removeMyBlackout: UnifiedToolDefinition = {
  ...
  async execute(args, context) {
    ...
    // Verify this is the person's own blackout
    const { data: blackout, error: fetchError } = await supabase
      .from('person_blackout_dates')
...
export const availabilityTools: UnifiedToolDefinition[] = [
  // Read tools
