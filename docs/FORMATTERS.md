...
**The `people` table has a database-generated `full_name` column.** Always use `person.full_name` directly instead of manually concatenating `first_name` and `last_name`.
...
**Migration:** `supabase/migrations/20251031000001_create_people_table.sql` (line 17)
