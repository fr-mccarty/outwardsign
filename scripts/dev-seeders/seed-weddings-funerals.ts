      ...
      const weddings = [
        {
          field_values: {
            ...
            first_reader: people[6].id,
            second_reader: people[7].id,
        ...
        },
        {
          field_values: {
            ...
            groom: people[2].id,
            presider: people[8].id,
            first_reader: people[9].id,
            second_reader: people[10].id,
            reception_location: hallLocation?.id || '',
        ...
        },
        {
          field_values: {
            ...
            groom: people[4].id,
            presider: people[8].id,
            first_reader: people[11].id,
            second_reader: people[12].id,
            reception_location: hallLocation?.id || '',
      ...
      const funerals = [
        ...
        },
        {
          field_values: {
            ...
            presider: people[8].id,
            first_reader: people[13].id,
            second_reader: people[6].id,
            burial_location: funeralHomeLocation?.id || '',
