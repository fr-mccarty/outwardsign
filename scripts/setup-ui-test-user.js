...
const envFilePath = path.join(__dirname, '..', '.env.production.test');
...
async function setupUITestUser() {
  ...
  try {
    ...
    console.log('1️⃣  Checking if UI test user exists...');
    ...
    // 5. Save credentials to .env.production.test
    console.log('\n5️⃣  Saving credentials to .env.production.test...');
