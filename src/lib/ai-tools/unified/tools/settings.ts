...
const getParishInfo: CategorizedTool = {
...
const listEventTypes: CategorizedTool = {
...
const getEventType: CategorizedTool = {
  name: 'get_event_type',
...
const listCustomLists: CategorizedTool = {
...
const getMassSettings: CategorizedTool = {
...
const getParishSettings: CategorizedTool = {
...
export const settingsTools: CategorizedTool[] = [
  getParishInfo,
  listEventTypes,
  getEventType,
  listCustomLists,
