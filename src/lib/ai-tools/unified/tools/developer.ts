 ...
 * Developer Tools
 *
 * Special tools only available to developers (admin scope required).
...
const inviteToDemoParish: CategorizedTool = {
...
const listDemoParishInvitations: CategorizedTool = {
  name: 'list_demo_parish_invitations',
  description: 'List all pending invitations for the demo parish. Developer only.',
  category: 'developer',
  inputSchema: {
    type: 'object',
    properties: {},
...
const revokeDemoParishInvitation: CategorizedTool = {
  name: 'revoke_demo_parish_invitation',
  description: 'Revoke a pending invitation for the demo parish. Developer only.',
  category: 'developer',
  inputSchema: {
    type: 'object',
    properties: {
...
export const developerTools: CategorizedTool[] = [
  inviteToDemoParish,
