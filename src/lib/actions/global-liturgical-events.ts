...
export async function getGlobalLiturgicalEvents(
  ...
  if (error) {
    logError('Error fetching global liturgical events: ' + (error instanceof Error ? error.message : JSON.stringify(error)))
...
export async function getGlobalLiturgicalEventsPaginated(
  ...
  if (error) {
    logError('Error fetching paginated global liturgical events: ' + (error instanceof Error ? error.message : JSON.stringify(error)))
...
export async function getGlobalLiturgicalEvent(
  ...
  if (error) {
    logError('Error fetching global liturgical event: ' + (error instanceof Error ? error.message : JSON.stringify(error)))
    return null
  }
