...
export default async function SacramentsPage({ params, searchParams }: PageProps) {
  ...
  return (
    <PageContainer
      ...
      description={`Manage ${eventType.name.toLowerCase()} sacraments.`}
      primaryAction={<ModuleCreateButton moduleName={eventType.name} href={`/sacraments/${event_type_slug}/create`} />}
    >
