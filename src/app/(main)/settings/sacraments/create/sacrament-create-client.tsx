...
export function SacramentCreateClient() {
  ...
  const onSubmit = async (data: CreateEventTypeData) => {
    ...
    try {
      ...
      console.error('Failed to create sacrament type:', error)
      toast.error('Failed to create sacrament type')
      setIsSubmitting(false)
    }
  }

  const handleCancel = () => {
    router.push('/settings/sacraments')
  }
