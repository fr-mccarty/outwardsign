...
interface SpecialLiturgiesListClientProps {
...
export function SpecialLiturgiesListClient({ initialData }: SpecialLiturgiesListClientProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success('Special liturgy type deleted successfully')
      setEventTypeToDelete(null)
      router.refresh()
    } catch (error) {
      console.error('Failed to delete special liturgy type:', error)
      const errorMessage = error instanceof Error ? error.message : 'Failed to delete special liturgy type'
  ...
  return (
    <>
            ...
            <div className="space-y-2">
              ...
              {items.length === 0 && (
                <div className="text-center py-12">
                  <p className="font-medium mb-2">{t('noSpecialLiturgies')}</p>
      ...
      <ConfirmationDialog
        ...
        title="Delete Special Liturgy Type"
