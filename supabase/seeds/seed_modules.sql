...
BEGIN
  ...
  -- Wedding 1 Events
  INSERT INTO events (parish_id, name, description, responsible_party_id, related_event_type, start_date, start_time, end_date, end_time, timezone, is_all_day, location_id, language, note)
