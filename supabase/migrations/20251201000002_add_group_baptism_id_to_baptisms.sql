...
COMMENT ON COLUMN baptisms.group_baptism_id IS 'Links individual baptism to a group baptism ceremony. When group_baptism_id is NULL, baptism is standalone. When group_baptism is deleted, linked baptisms have their group_baptism_id set to NULL (SET NULL).';
