...
-- Purpose: Mass intention requests that can be assigned to calendar_events (specific mass times)
...
CREATE INDEX idx_mass_intentions_calendar_event_id ON mass_intentions(calendar_event_id);
