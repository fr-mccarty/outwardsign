...
CREATE TABLE input_field_definitions (
  ...
  CONSTRAINT check_input_field_type CHECK (type IN ('person', 'group', 'location', 'list_item', 'document', 'text', 'rich_text', 'content', 'petition', 'calendar_event', 'date', 'time', 'datetime', 'number', 'yes_no', 'mass-intention', 'spacer')),
